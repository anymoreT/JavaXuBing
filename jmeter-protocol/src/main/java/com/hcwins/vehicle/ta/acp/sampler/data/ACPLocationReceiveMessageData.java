...
public class ACPLocationReceiveMessageData extends AbstractACPMessageData {
    ...
    public ACPLocationReceiveMessageData() {
        super();
...
//        return vo.encode();
        ...
        setCurrentMessageData(String.format("this message is generated by ACPLocationReceiveMessageData - %d", getIndex()).getBytes());
    ...
    public static ACPLocationReceiveMessageData getSampleMessageData() {
        ACPLocationReceiveMessageData vo = new ACPLocationReceiveMessageData();
